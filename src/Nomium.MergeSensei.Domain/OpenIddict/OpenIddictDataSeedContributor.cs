...
namespace Nomium.MergeSensei.OpenIddict;
    ...
    : IDataSeedContributor, ITransientDependency
{
    ...
    {
        foreach (var (roleName, permissions) in GetDefaultPermissionsForRoles())
        {
    ...
    private Dictionary<string, string[]> GetDefaultPermissionsForRoles()
    {
        var permissions = new[]
        {
            "MergeSensei.AiModels",
            "MergeSensei.AiModels.Create",
            "MergeSensei.AiModels.Edit",
            "MergeSensei.AiModels.Delete"
        };
    ...
    {
        if (await openIddictScopeRepository.FindByNameAsync("MergeSensei") == null)
        {
            await scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "MergeSensei", DisplayName = "MergeSensei API", Resources = { "MergeSensei" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["MergeSensei_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["MergeSensei_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["MergeSensei_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["MergeSensei_Swagger:RootUrl"]?.TrimEnd('/');
        ...
        string? logoUri = null)
    {
        ...
        if (!client.ClientUri.Equals(application.ClientUri))
        {
