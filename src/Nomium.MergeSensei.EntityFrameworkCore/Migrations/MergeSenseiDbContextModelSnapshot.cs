...
namespace Nomium.MergeSensei.Migrations
{
    ...
    partial class MergeSenseiDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nomium.MergeSensei.Entities.AiModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Nomium.MergeSensei.Entities.Branch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Nomium.MergeSensei.Entities.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Nomium.MergeSensei.Entities.GroupProject", b =>
                {
            ...
            modelBuilder.Entity("Nomium.MergeSensei.Entities.Node", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Nomium.MergeSensei.Entities.NodeType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Nomium.MergeSensei.Entities.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Nomium.MergeSensei.Entities.Repository", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Nomium.MergeSensei.Entities.Trigger", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Nomium.MergeSensei.Entities.TriggerType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Nomium.MergeSensei.Entities.GroupProject", b =>
                {
                    b.HasOne("Nomium.MergeSensei.Entities.Group", null)
                        .WithMany()
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Nomium.MergeSensei.Entities.Project", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Nomium.MergeSensei.Entities.Node", b =>
                {
                    b.HasOne("Nomium.MergeSensei.Entities.NodeType", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Nomium.MergeSensei.Entities.PipelineNode", b =>
                {
                    b.HasOne("Nomium.MergeSensei.Entities.Node", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Nomium.MergeSensei.Entities.PipelineTrigger", b =>
                {
                    ...
                    b.HasOne("Nomium.MergeSensei.Entities.Trigger", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Nomium.MergeSensei.Entities.Trigger", b =>
                {
                    ...
                    b.HasOne("Nomium.MergeSensei.Entities.TriggerType", null)
                        .WithMany()
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
