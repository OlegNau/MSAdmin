...
public class MergeSenseiDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        MergeSenseiGlobalFeatureConfigurator.Configure();
        MergeSenseiModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<MergeSenseiDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<MergeSenseiResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/MergeSensei");

            options.DefaultResourceType = typeof(MergeSenseiResource);
        ...
        {
            options.MapCodeNamespace("MergeSensei", typeof(MergeSenseiResource));
        });
    }
}
